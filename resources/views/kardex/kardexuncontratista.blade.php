...
<section>
	<?php 
		...
		$totalganado=0;
	?>
	<h1>KARDE DEL CONTRATISTA</h1>
	<H1></H1>
	<header>
		<div id="pri">
			<p>CI CONTRATISTA: {{$dato[0]->ciC}}</p>
		  <p>NOMBRE: {{$dato[0]->nombreC}}</p>
		  <p>COMUNIDAD: {{$dato[0]->centro}}</p>
		</div>
	...
	<table class="table table-bordered table table-sm">
		<thead>
    <tr>
    	<th scope="col">NOMBRE ZAFRERO</th>
	...
	?>
		...
		</table>                                                                                                                                            <H2>TOTAL PRODUCIDO:{{$totalP}} Bs</H2>                                                                        <div>  
	...
	@endforeach	
		...
		</table>                                                                     <H2>TOTAL ANTICIPO:{{$totalA}} Bs</H2>      
